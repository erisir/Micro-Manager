...
MODULE_API void InitializeModuleData()
{
	...
	RegisterDevice( XMTE517::Instance()->GetXMTStr(XMTE517::XMTSTR_CtrlDevName).c_str(),MM::GenericDevice,  XMTE517::Instance()->GetXMTStr(XMTE517::XMTSTR_CtrlDevName).c_str());

	// initialize the Z stage device name
	RegisterDevice(XMTE517::Instance()->GetXMTStr(XMTE517::XMTSTR_ZStageDevName).c_str(),MM::StageDevice, XMTE517::Instance()->GetXMTStr(XMTE517::XMTSTR_ZStageDevName).c_str());
}
