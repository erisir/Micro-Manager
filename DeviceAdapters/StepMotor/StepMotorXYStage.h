...
#ifndef _StepMotorXYSTAGE_H_
#define _StepMotorXYSTAGE_H_
...
//
// define XY stage class that is atached to the StepMotor controller
//
...
public:
    ...
    // Busy is not applicable for StepMotor
    ...
    // Get limits of the X-Y stage, not applicable for StepMotor XY stage
