...
MODULE_API void InitializeModuleData()
{
	...
	RegisterDevice( StepMotor::Instance()->GetXMTStr(StepMotor::XMTSTR_CtrlDevName).c_str(),MM::GenericDevice,  StepMotor::Instance()->GetXMTStr(StepMotor::XMTSTR_CtrlDevName).c_str());
