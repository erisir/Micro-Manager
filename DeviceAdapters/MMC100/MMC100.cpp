...
MODULE_API void InitializeModuleData()
{
	...
	AddAvailableDeviceName( MMC100::Instance()->GetSKStr(MMC100::SKSTR_CtrlDevName).c_str(),  MMC100::Instance()->GetSKStr(MMC100::SKSTR_CtrlDevName).c_str());

	// initialize the Z stage device name
	AddAvailableDeviceName(MMC100::Instance()->GetSKStr(MMC100::SKSTR_ZStageDevName).c_str(), MMC100::Instance()->GetSKStr(MMC100::SKSTR_ZStageDevName).c_str());
}
...
int             MMC100::m_nTimeoutInterval   = 10000;        // timeout interval
int             MMC100::m_nTimeoutTrys       = 5;            // timeout trys
