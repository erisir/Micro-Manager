...
MPError::MPError()
{
    ...
    MPError::m_sErrorText[MPError::MPERR_SerialZeroReturn]      = "No response from MMC100 controller";                                         // No Response from serial port
    MPError::m_sErrorText[MPError::MPERR_SerialUnknownError]    = "Unknown error codes";                                                       // Unknown serial command
    MPError::m_sErrorText[MPError::MPERR_GENERIC]               = "MMC100 adapter error occured";                                               // Unspecified MMC100 adapter errors
...
{
    string sErrorText;      // MMC100 String
