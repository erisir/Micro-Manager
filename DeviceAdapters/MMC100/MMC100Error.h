...
//-----------------------------------------------------------------------------
// DESCRIPTION:   MMC100 Device Adapter Error Codes & Messages
//
...
#ifndef _MMC100ERROR_H_
#define _MMC100ERROR_H_
...
public:
    ...
    enum _MPErr
    {
        ...
        MPERR_GENERIC                   = 8,        // Unspecified MMC100 adapter errors
