...
#ifndef _MMC100ZSTAGE_H_
#define _MMC100ZSTAGE_H_
...
//
// define Z stage class that is atached to the MMC100 controller
//
...
public:
    ...
    // Busy is not aplicable for MMC100
    ...
    // MMC100, the function will return DEVICE_OK
    // insttead.
