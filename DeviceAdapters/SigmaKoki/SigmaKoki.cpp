...
MODULE_API void InitializeModuleData()
{
	...
	RegisterDevice( SigmaKoki::Instance()->GetSKStr(SigmaKoki::SKSTR_CtrlDevName).c_str(),MM::GenericDevice, SigmaKoki::Instance()->GetSKStr(SigmaKoki::SKSTR_CtrlDevName).c_str());

	// initialize the Z stage device name
	RegisterDevice(SigmaKoki::Instance()->GetSKStr(SigmaKoki::SKSTR_ZStageDevName).c_str(), MM::StageDevice ,SigmaKoki::Instance()->GetSKStr(SigmaKoki::SKSTR_ZStageDevName).c_str());
}
